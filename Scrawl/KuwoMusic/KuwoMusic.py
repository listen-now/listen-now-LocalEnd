...
class KuwoMusic(object):
    ...
    def __init__(self):
        ...
        #                  http://comment.kuwo.cn/com.s?type=get_comment&uid=0&prod=newWeb&digest=15&sid=80403&page=1&rows=20&f=web
        ...
        try:
            if resp["HIT"] != 0 :
                ...
                for re in re_dict['song']['list']:
                    re['music_name'] = re['music_name'].replace('&nbsp;', ' ')
                    re['artists'] = re['artists'].replace('&nbsp;', ' ')
...
if __name__=="__main__":
    ...
    # print(test.Search_List('最炫名族风'))
    print(test.Search_details(80403))
